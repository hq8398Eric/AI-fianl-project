...
from ShuttleNet.ShuttleNet_embedding import PositionalEncoding, PlayerEmbedding, ShotEmbedding, AreaEmbedding
...
class ShotGenDecoder(nn.Module):
    def __init__(self, config):
        ...
        self.p_area_embedding = AreaEmbedding(config['my_area_num'], config['my_area_dim'])
        self.o_area_embedding = AreaEmbedding(config['my_area_num'], config['my_area_dim'])
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_p_area, input_o_area, encode_local_output, encode_global_A, encode_global_B, trg_mask=None, return_attns=False):
        ...
        embedded_p_area = self.p_area_embedding(input_p_area)
        embedded_o_area = self.o_area_embedding(input_o_area)

        h_a = embedded_area + embedded_p_area + embedded_o_area + embedded_player
        h_s = embedded_shot + embedded_p_area + embedded_o_area + embedded_player
...
class ShotGenPredictor(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_p_area, input_o_area, encode_local_output, encode_global_A, encode_global_B, target_player, return_attns=False):
        embedded_target_player = self.player_embedding(target_player)
        if return_attns:
            decode_output, decoder_self_attention_list, decoder_encoder_self_attention_list, disentangled_weight_local = self.shotgen_decoder(input_shot, input_x, input_y, input_player, input_p_area, input_o_area, encode_local_output, encode_global_A, encode_global_B, return_attns=return_attns)
        else:
            decode_output = self.shotgen_decoder(input_shot, input_x, input_y, input_player, input_p_area, input_o_area, encode_local_output, encode_global_A, encode_global_B, return_attns)
...
class ShotGenEncoder(nn.Module):
    ...
    def forward(self, input_shot, input_x, input_y, input_player, input_p_area, input_o_area, src_mask=None, return_attns=False):
        enc_slf_attn_list = []
